                ...
                children: [
                  InkWell(
                    ...
                    child: Icon(
                      ...
                      color: isDarkMood ? Colors.white.withOpacity(0.6) : Colors.black.withOpacity(0.2),
                    ),
                  ),
                  Text(
                    'Messages',
                    style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: isDarkMood ? Colors.white : Colors.black),
                  ),
                  Container(
                    height: 35,
                    width: 35,
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: isDarkMood ? Colors.white : Colors.black),
                        ),
                      ],
                    ),
                    SizedBox(width: 30),
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(fontWeight: FontWeight.bold, color: isDarkMood ? Colors.white : Colors.black),
                                  ),
                                  SizedBox(height: 3),
                                  Text(
                                    ...
                                    style: TextStyle(
                                        color: !mockUsersList[i].isRead
                                            ? Colors.blue[400]
                                            : isDarkMood ? Colors.white.withOpacity(0.7) : Colors.black.withOpacity(0.5),
                                        fontSize: 12),
                                  )
                                ],
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(fontSize: 12, color: isDarkMood ? Colors.white.withOpacity(0.7) : Colors.black),
                                    ),
                                    SizedBox(height: 5),
